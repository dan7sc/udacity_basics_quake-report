...
object QueryUtils {
    ...
    private fun extractFeatureFromJson(earthquakeJSON: String): List<Earthquake>? {
        ...
        try {
            ...
            val earthquakeArray: JSONArray = baseJsonResponse.getJSONArray("features")

            // For each earthquake in the earthquakeArray, create an {@link Earthquake} object
            for (i: Int in 0 until earthquakeArray.length()) {

                // Get a single earthquake at position i within the list of earthquakes
                val currentEarthquake: JSONObject = earthquakeArray.getJSONObject(i)
